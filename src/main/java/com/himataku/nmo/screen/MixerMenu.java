...
public class MixerMenu extends AbstractContainerMenu {
    ...
    public MixerMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.MIXER_MENU.get(), pContainerId);
        ...
        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 0, 4, 34));
        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 1, 54, 34));
        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 2, 128, 34));
